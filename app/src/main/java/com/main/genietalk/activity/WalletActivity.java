...
import com.main.genietalk.fragment.DocumentFragment;
import com.main.genietalk.fragment.GenieMoneyFragment;
import com.main.genietalk.fragment.GenieRewardFragment;
import com.main.genietalk.fragment.MemberShipFragment;
import com.main.genietalk.fragment.PastFragment;
import com.main.genietalk.fragment.PaymentMethodFragment;
...
public class WalletActivity extends BaseActivity {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                *//*Snackbar.make(view, "Action", Snackbar.LENGTH_LONG)
                ...
                Intent intent = new Intent(WalletActivity.this, AddPaymentMethodActivity.class);
    ...
    private void init() {
        ...
        headerTV.setText(getString(R.string.wallet));
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFrag(new GenieMoneyFragment(), "Genie Money");
        adapter.addFrag(new PaymentMethodFragment(), "Payment Method");
        adapter.addFrag(new GenieRewardFragment(), "Genie Reward");
        adapter.addFrag(new MemberShipFragment(), "Membership");
