...
import com.main.genietalk.activity.BaseActivity;
...
public class Main2Activity extends BaseActivity {
       ...
       // mSectionsPagerAdapter = new SectionsPagerAdapter(getSupportFragmentManager());
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Main2Activity.this, BusinessProfileActivity.class);
    ...
    private void init() {
        ...
        headerTV.setText(getString(R.string.profile));
        headerTV.setTextColor(Color.parseColor(themeArra[6]));
    }
    private void setupViewPager(ViewPager viewPager) {
        ViewPagerAdapter adapter = new ViewPagerAdapter(getSupportFragmentManager());
        adapter.addFrag(new ProfileFragment(), "Profile");
        adapter.addFrag(new RelationsFragment(), "Relation");
