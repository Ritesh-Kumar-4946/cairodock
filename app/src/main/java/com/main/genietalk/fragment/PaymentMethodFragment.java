...
import com.main.genietalk.adapter.MembershipAdapter;
import com.main.genietalk.adapter.PaymentMethodAdapter;
...
public class PaymentMethodFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        recycler_view_notifications = (RecyclerView)view.findViewById(R.id.recycler_view_upcoming);

        mAdapter = new PaymentMethodAdapter(getActivity(),movieList);
